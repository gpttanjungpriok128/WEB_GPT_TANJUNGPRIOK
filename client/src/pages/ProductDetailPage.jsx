...
function ProductDetailPage() {
  ...
  const submitReview = async () => {
    ...
    try {
      ...
      const response = await api.post(`/store/products/${slug}/reviews`, payload, {
        headers: {
      ...
      setReviewFeedback({
        type: "success",
        text: response?.data?.message || "Terima kasih! Ulasan kamu sudah tercatat.",
      });
      setReviewForm((previous) => ({
        ...previous,
        rating: 5,
        ...
        <nav className="relative z-10 flex flex-wrap items-center justify-between gap-4 text-[11px] uppercase tracking-[0.22em] text-brand-500 dark:text-brand-400">
          ...
          <div className="flex items-center gap-4 normal-case tracking-normal">
            <Link
              ...
              className="relative inline-flex items-center justify-center text-xs font-medium text-brand-600 transition hover:text-brand-900 dark:text-brand-300 dark:hover:text-white"
